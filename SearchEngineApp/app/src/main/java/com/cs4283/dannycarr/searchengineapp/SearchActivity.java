...
public class SearchActivity extends AppCompatActivity {
    ...
    void hideConnectingText() {findViewById(R.id.tvConnecting).setVisibility(View.GONE);}
    ...
    void hideWaiting() { findViewById(R.id.waiting).setVisibility(View.GONE);}

    void showWaiting() { findViewById(R.id.waiting).setVisibility(View.VISIBLE);}

    void hideResults() { findViewById(R.id.llResults).setVisibility(View.GONE);}
}
